      ...
      <div class="overflow-hidden position-relative h-100">
        ...
        <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
          <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">
            New Arrivals</h6>
          <h2 class="h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5">SoleCircuit</h2>
          <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">The Number 1 Shoe Retail Store</h2>
          <a href="#"
    ...
    <div class="swiper-slide">
      <div class="overflow-hidden position-relative h-100">
        ...
        <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
          <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">
            New Arrivals</h6>
          <h2 class="h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5">Where Your Shoes is In Our Hands</h2>
          <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">SoleCircuit</h2>
          <a href="#"
            class="btn-link btn-link_lg default-underline fw-medium animate animate_fade animate_btt animate_delay-7">Shop
            Now</a>
        </div>
    ...
    <div class="swiper-slide">
      <div class="overflow-hidden position-relative h-100">
        ...
        <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
          <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">
            New Arrivals</h6>
          <h2 class="h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5">December Sale!!</h2>
          <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5">Limited Time Offer</h2>
          <a href="#"
            class="btn-link btn-link_lg default-underline fw-medium animate animate_fade animate_btt animate_delay-7">Shop
            Now</a>
        </div>
