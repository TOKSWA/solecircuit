...
<head>
    ...
    <title>{{ config('app.name', 'SoleCircuit') }}</title>
                ...
                <div class="section-content-right">
                                            ...
                                            <li>
                                                <ul>
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        ...
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="product-list.html" class="body-text"><span class="pr-6px"> {{Auth::user()->name}} </span></a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="mb-10">
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2024 SoleCircuit</div>
                        </div>
                    </div>
